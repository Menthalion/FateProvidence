...
Stunt families can have a tracker to limit the use of specific skills belonging to the family. The description of these skills should include the limit cost per use. The limit tracker should have a size and contain a description of the consequences when filled up, and how points can be replenished.
...
Splitting up the origin axis (*brawn, grace, data, logic, presence, tact*) into the realm (*material, conceptual, spiritual*) and style (*power, mastery*) axes made it possible to abstract away most of the realm axis with the use of stunt families. This left only the act axis (*observe, achieve, improve, undo, endure*) and style axis (*power, mastery*) for a total of 10 skills.

The original table and axes can be useful as categorization for scoping stunts. The canonical names for the original 30 skills are still in use as skill  examples in the format *act* by *style: material / conceptual / spiritual*
