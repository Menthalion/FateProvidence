...
Stunt families act as narrative license like aspects, but cannot be invoked. They need to be bought with refresh points; since each stunt family doubles  narrative license to use all ranked skills, refresh cost should double as well: 1 for the first, 2 for the second, 4 for the third... 
...
Identical to their Fate Core counterparts, bonus stunts give a +2 bonus in specific situations.
...
Every skill in the list has a mirror: one governed by power, one by mastery. If it is ambiguous which applies to a stated action, you can use the highest of the two.
